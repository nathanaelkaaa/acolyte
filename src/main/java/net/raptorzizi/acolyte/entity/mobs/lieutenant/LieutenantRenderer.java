...
public class LieutenantRenderer extends AbstractSpellCastingMobRenderer {

    public LieutenantRenderer(EntityRendererProvider.Context context) {
        super(context, new LieutenantModel());
