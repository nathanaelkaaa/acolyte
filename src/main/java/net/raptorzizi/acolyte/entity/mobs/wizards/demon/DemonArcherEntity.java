...
public class DemonArcherEntity extends DemonEntity implements RangedAttackMob {

    private int attackAnimationTick = 0;

    private static final EntityDataAccessor<Boolean> IS_CHARGING_BOW =
            SynchedEntityData.defineId(DemonArcherEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> IS_RELEASING_BOW =
            SynchedEntityData.defineId(DemonArcherEntity.class, EntityDataSerializers.BOOLEAN);

    private final AnimationController<DemonArcherEntity> bowController =
            new AnimationController<>(this, "bow_controller", 2, this::bowPredicate);

    public DemonArcherEntity(EntityType<? extends AbstractSpellCastingMob> pEntityType, Level pLevel) {
